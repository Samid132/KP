...
<div class="modal fade" id="scheduleModal1" role="dialog" aria-labelledby="modal-slideup" aria-hidden="true">
            ...
            <form action="jadwal" enctype="multipart/form-data" method="post" onsubmit="return true;">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <div class="block-content">
                        <input type="hidden" name="_token" value="t9jSt6PbcPUo52DZsiZhTiBnKCAfxU39MEJRIWaM">                        <div class="form-group row">
                            <label class="col-12" for="code">Kode Jadwal</label>
                            <div class="col-md-12">
                                <input type="text" class="form-control" id="code" name="code" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-12" for="name">Nama Jadwal</label>
                            <div class="col-md-12">
                                <input type="text" class="form-control" id="name" name="nama_jadwal" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-12" for="entry_time">Jam Masuk</label>
                            <div class="col-md-12">
                                <input type="text" class="js-flatpickr form-control bg-white" id="entry_time" name="jam_masuk" data-enable-time="true" data-no-calendar="true" data-date-format="H:i:s" data-time_24hr="true">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-12" for="return_time">Jam Pulang</label>
                            <div class="col-md-12">
                                <input type="text" class="js-flatpickr form-control bg-white" id="return_time" name="jam_pulang" data-enable-time="true" data-no-calendar="true" data-date-format="H:i:s" data-time_24hr="true">
                ...
                <div class="modal-footer">
                    ...
                    <button name="Submit" value="add" class="btn btn-alt-success"><i class="fa fa-check"></i> Tambah</button>
                </div>
            </form>
        </div>
    </div>
 ...
 <!-- end modal1 -->
            ...
            <main id="main-container">
                ...
                <div class="block-options">
                    <button type="button" class="btn-block-option text-white" data-toggle="modal" data-target="#scheduleModal1">
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell"><?php echo addslashes($res['nama_jadwal']);?></td>
                                        ...
                                        <a type="button" class="btn btn-circle btn-alt-warning mr-5 mb-5 , open_modal" id='<?php echo  $res['id_jadwal']; ?>' data-toggle="modal"  title="Edit">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                        <a type="button" class="btn btn-circle btn-alt-danger mr-5 mb-5" data-toggle="tooltip" href="hjadwal/<?php echo addslashes($res['id_jadwal']);?>"title="Delete">
