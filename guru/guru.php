        ...
        <div class="modal fade" id="scheduleModal1" role="dialog" aria-labelledby="modal-slideup" aria-hidden="true">
            <div class="modal-dialog modal-dialog-slideup" role="document">
                <div class="modal-content">
                    <form action="guru" enctype="multipart/form-data" method="post" onsubmit="return true;">
                        <div class="block block-themed block-transparent mb-0">
                            <div class="block-header bg-primary-dark">
                                <h3 class="block-title modalTitle">Tambah Guru</h3>
                            ...
                            <div class="block-content">
                                ...
                                <div class="form-group row">
                                    <label class="col-12" for="name">Nama Guru</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-12" for="name">Password</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-12" for="name">Mapel</label>
                                    <div class="col-md-12">
...
{
?>
                                            <option value="<?php echo $res['id_mapel']?>">
...
?>
        ...
        <main id="main-container">
            ...
            <!-- Page Content -->
            <div class="content">
                <h2 class="content-heading bg-body-dark text-center">Data Guru</h2>

                <div class="block-header block-header-default bg-gd-primary">
                    <h3 class="block-title text-white">Guru Management</h3>
                    <div class="block-options">
                ...
                <div class="block">
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <?php
                                    ...
                                    $result = mysqli_query($mysqli, "SELECT * FROM table_users where hak_akses='guru' ");
                                    $no=1;
                                    ?>
                            ...
                            <tbody>
                                <?php
		                            while($res = mysqli_fetch_array($result)) {	
                                        ...
                                        $mapel = mysqli_query($koneksi, "SELECT nama_mapel FROM mapel WHERE id_mapel = $id_mapel");
                                        $m = mysqli_fetch_assoc($mapel); 
                                     ?>
                                <tr>
                                    <td class="text-center"><?php echo $no++;?></td>
                                    <td class="font-w600"><?php echo addslashes($res['nama']);?></td>
                                    <td class="d-none d-sm-table-cell">
                                        <?php echo addslashes($m['nama_mapel']);?>
                                    </td>
                                    <td class="d-none d-sm-table-cell">
                                        <?php echo addslashes($res['username']);?></td>
                                    <td class="d-none d-sm-table-cell">
                                        <?php echo addslashes($res['password']);?></td>

                                    <td class="d-none d-sm-table-cell">
                                        <?php echo addslashes($res['hak_akses']);?></td>
...
?>
    ...
    <!--
        ...
        -->
    <?php
include "prosestambah/pguru.php"
?>
    <?php
