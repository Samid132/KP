        ...
        <div class="modal fade" id="scheduleModal1" role="dialog" aria-labelledby="modal-slideup" aria-hidden="true">
            <div class="modal-dialog modal-dialog-slideup" role="document">
                <div class="modal-content">
                    <form action="mapel" enctype="multipart/form-data" method="post" onsubmit="return true;">
                        <div class="block block-themed block-transparent mb-0">
                            <div class="block-header bg-primary-dark">
                                <h3 class="block-title modalTitle">Tambah mapel</h3>
                            ...
                            <div class="block-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="name" name="nama_mapel" required>
                                    </div>
                                </div>
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="d-none d-sm-table-cell">Nama mapel</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-none d-sm-table-cell"><?php echo addslashes($res['nama_mapel']);?></td>
                                    ...
                                    <td class="text-center">
                                        <a type="button" class="btn btn-circle btn-alt-warning mr-5 mb-5 , open_modal"
                                            id='<?php echo  $res['id_mapel']; ?>' data-toggle="modal" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a type="button" class="btn btn-circle btn-alt-danger mr-5 mb-5"
                                            data-toggle="tooltip"
                                            href="hmapel/<?php echo addslashes($res['id_mapel']);?>" title="Delete">
...
?>
    ...
    <?php
include "prosestambah/pmapel.php"
?>
    <?php
