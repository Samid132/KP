...
?>
        ...
        <main id="main-container">
            ...
            <!-- Page Content -->
            <div class="content">
                <h2 class="content-heading bg-body-dark text-center">Laporan Absen user</h2>

                <div class="block-header block-header-default bg-gd-primary">
                    <h3 class="block-title text-white">Laporan Absen Management</h3>
                    <div class="block-options">
                        ...
                        <button type="button" class="btn-block-option text-white" value="Import as Excel"
                            onclick="saveAsExcel('laporan', 'laporan.xls')">
                ...
                <div class="block">
                    ...
                    <div class="block-content block-content-full">
                        <p>
                        <form method="post">
                            <div class="input-control" data-role="datepicker">
                                <input type="date" class="col-md-4" name='cari' placeholder='yyyy-mm-dd'>
                                <strong> Sampai Dengan </strong>
                                <input type="date" class="col-md-4" name='cari1' placeholder='yyyy-mm-dd'>

                                <select class="js-select2 col-md-4" id="6" style="width: 100%;" name="cari2">
                                    <option>Pilih Filter Nama...</option>
                                    <?php
...
{
?>
                                    <option value="<?php echo $res['id_user']?>"><?php echo $res['idsr_nama'] ?>
                                    </option>
                                    <?php
...
?>
                                ...
                                <input class='btn btn-danger col-md-1 input-control' type='submit' name=submit
                                    value='Cari' />
                            </div>
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination"
                            ...
                            <tbody>
                                ...
                                if(isset($_POST['cari'])){
                                    ...
                                    $cari1=$_POST['cari1'];
                                    $cari2=$_POST['cari2'];
                                    if ($cari2==null&&$cari1==null&&$cari==null) {
                                      $cari=0;
                                      $cari1=0;
                                      $cari2=0;
                                    }
                  ...
                  $no = 1;
                  $absen = mysqli_query($koneksi, "SELECT * FROM absen WHERE tanggal BETWEEN '$cari' And '$cari1' And  id_user = '$cari2';");
                  while ($a = mysqli_fetch_array($absen)) {
                    ...
                    $jadwal = mysqli_query($koneksi, "SELECT nama_jadwal FROM jadwal WHERE id_jadwal = $id_jadwal");
                    $j = mysqli_fetch_assoc($jadwal); 
                                ...
                                <tr>
                                    ...
                                    <td class="d-none d-sm-table-cell"><?php echo addslashes($a['ket_absen']);?></td>
                                    <td class="d-none d-sm-table-cell"><?php echo addslashes($a['tanggal']);?></td>
