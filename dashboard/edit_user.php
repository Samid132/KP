                        ...
                        <form action="../user/<?php echo addslashes($id_user);?>" method="POST"
                            ...
                            <div class="row items-push">
                                <div class="col-xl-6 ">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="profile-settings-email">Password</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control form-control-lg"
                                                   readonly
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <select class="form-control" id="example-select"
                                                    ...
                                                    <option value="Masih Aktif Di Sekolah">Masih Aktif Di Sekolah</option>
                                                    <option value="Sudah Tidak Aktif Di Sekolah">Sudah Tidak Aktif Di Sekolah</option>
